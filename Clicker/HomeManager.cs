...
public class HomeManager : MonoBehaviour
{
    ...
    public Text TextMoney; // ïåðåâîæó äåíüãè â òåêñò

    public Text TextPassiveMoneyOnOneSecond; //òåêñò ïàñèâà  çà îäíó ñåêóíäó
    public Text TextDoublePassiveMoneyOnOneSecond; //òåêñò óäâàèâàíèÿ ïàññèâà  çà îäíó ñåêóíäó

    public Text TextMoneyOnOneClick;// òåêñò  çà îäèí òàï
    public Text TextDoubleMoneyOnOneClick; // òåêñò óäâàèâàíèÿ çà îäèí òàï
